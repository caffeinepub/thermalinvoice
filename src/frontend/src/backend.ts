...
import type { ApprovalStatus as _ApprovalStatus, StoreProfile as _StoreProfile, UserApprovalInfo as _UserApprovalInfo, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllStores(): Promise<Array<StoreEntry>> {
        if (this.processError) {
            try {
    ...
    async getMyStoreProfile(): Promise<StoreProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyStoreProfile();
    ...
    async isFirstRunNeeded(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isFirstRunNeeded();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listAllUsers(): Promise<Array<UserApprovalInfo>> {
        if (this.processError) {
            try {
    ...
    async saveStoreProfile(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<StoreProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.saveStoreProfile(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setStoreStatus(arg0: Principal, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setStoreStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setUserStatus(arg0: Principal, arg1: ApprovalStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUserStatus(arg0, to_candid_ApprovalStatus_n12(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StoreProfile]): StoreProfile | null {
    return value.length === 0 ? null : value[0];
}
